...
public class DateUtilTest {
  ...
  void previousPeriod(
      LocalDate start,
      LocalDate end,
      LocalDate expectedPreviousDateStart,
      LocalDate expectedPreviousDateEnd) {
    Assertions.assertThat(DateUtil.previousPeriod(start, end))
        .isEqualTo(Pair.of(expectedPreviousDateStart, expectedPreviousDateEnd));
  }

  // TODO: More test cases
  private static Stream<Arguments> splitRangeSource() {
    return Stream.of(
        Arguments.of(LocalDate.of(2019, 1, 1), LocalDate.of(2019, 1, 1), true, List.of()),
        Arguments.of(
            LocalDate.of(2019, 1, 1),
            LocalDate.of(2019, 1, 2),
            true,
  ...
  void splitRange(
      LocalDate start, LocalDate end, boolean stepInDays, List<Pair<LocalDate, LocalDate>> ranges) {
